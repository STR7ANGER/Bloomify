      ...
      <div className="bg-white shadow-lg drop-shadow-xl p-6 w-[40rem] text-center border border-gray-200 rounded-2xl">
        ...
        <div className="grid grid-cols-2 gap-2">
          <input
            ...
            className="p-2 rounded-md border border-gray-300 bg-gray-50 font-light placeholder-gray-800"
          />
          <input
            type="text"
          ...
          <select
            id="options"
            name="options"
            className="appearance-none p-2 rounded-md border border-gray-300 bg-gray-50 font-light col-span-2"
          >
          ...
          <p className="text-center col-span-2 mt-5 font-light">
            ...
            <Link to="/login" className="text-blue-700 tracking-[-0.03em]">
              Log In
            </Link>
          </p>
        </div>
