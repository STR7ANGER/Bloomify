...
const BecomeSeller = () => {
  return (
    <>
    <section className="relative bg-gray-100 border border-gray-300 rounded-3xl my-20 py-16 flex flex-col md:flex-row items-center justify-between container mx-auto shadow-lg">
      <div className="px-6 md:px-20 py-40">
        <img
          src={logoBloomify}
          alt="Bloomify"
        ...
        <img
          src={logo}
          alt="BloomifyLogo"
          className="absolute top-10 right-14 w-48"
        />
